...
module.exports = function makeWebpackConfig () {
  ...
  config.output = env.test ? {} : {
    ...
    publicPath: env.prod ? '/' : 'http://localhost:' + devPort + '/',
  ...
  config.module = {
    rules: [{
      ...
      loaders: [{loader: 'style-loader'}, {loader: 'css-loader', options: {sourceMap: true}},/* {loader: 'sass-loader', options: {sourceMap: true}}*/]
    }, {
      // ASSET LOADER
